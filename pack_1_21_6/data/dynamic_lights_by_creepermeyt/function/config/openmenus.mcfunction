...
execute if score @s dynbcmenus matches 6 run function dynamic_lights_by_creepermeyt:config
...
execute if score @s dynbcmenus matches 10 run function dynamic_lights_by_creepermeyt:internal/load
