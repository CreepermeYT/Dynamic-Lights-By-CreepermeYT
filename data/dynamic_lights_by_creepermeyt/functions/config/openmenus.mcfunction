...
execute if score @s dynbcmenus matches 6 run function dynamic_lights_by_creepermeyt:config/config

execute if score @s dynbcmenus matches 7 run function dynamic_lights_by_creepermeyt:config/.toggle_preset
execute if score @s dynbcmenus matches 8 run function dynamic_lights_by_creepermeyt:config/oconfig
execute if score @s dynbcmenus matches 9 run function dynamic_lights_by_creepermeyt:config/.uninstall

execute if score @s dynbcmenus matches 10 run function dynamic_lights_by_creepermeyt:config/.reload
