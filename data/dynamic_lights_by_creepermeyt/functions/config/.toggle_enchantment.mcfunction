...
execute if score e dynbclevel matches 0 run tellraw @s [{"text":"-> ","color":"white","bold":true},{"text":"Disabled ","color":"red"},{"text":"Enchanted","bold":true,"color":"dark_purple"},{"text":" items","bold":false}]
execute if score e dynbclevel matches 1 run tellraw @s [{"text":"-> ","color":"white","bold":true},{"text":"Enabled ","color":"green"},{"text":"Enchanted","bold":true,"color":"dark_purple"},{"text":" items","bold":false}]
