...
execute if predicate dynamic_lights_by_creepermeyt:mainhand_lightlvl_7 run scoreboard players set @s dynbclevel 7
execute if predicate dynamic_lights_by_creepermeyt:offhand_lightlvl_7 run scoreboard players set @s dynbclevel 7

execute if predicate dynamic_lights_by_creepermeyt:mainhand_lightlvl_5 run scoreboard players set @s dynbclevel 5
execute if predicate dynamic_lights_by_creepermeyt:offhand_lightlvl_5 run scoreboard players set @s dynbclevel 5
