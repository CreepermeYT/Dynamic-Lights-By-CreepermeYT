execute unless score l dynbclevel matches 0.. run return 0
...
execute as @e[type=marker,tag=dynbc.new] store result score @s dynbclevel run scoreboard players get l dynbclevel
