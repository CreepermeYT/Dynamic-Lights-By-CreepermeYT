say Dynamic Lights by CreepermeYT v1.3.4 is designed for 1.21 to 1.21.6 ONLY!
tellraw @a ""
tellraw @a ""
tellraw @a ""
tellraw @a ""
...
tellraw @a ""
tellraw @a [{"text": "          Compatible Versions: ","color":"green","bold":true},{"text":"[ 1.21 - 1.21.6 ]","color":"gray","bold":true}]
tellraw @a ""
tellraw @a {"text":"-----------------------------------------------------","color":"dark_red"}